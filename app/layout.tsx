...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.aloyz.co"),
  title: {
    default: "Aloyz | WhatsApp ve Instagram Otomasyon Paneli",
    template: "%s | Aloyz",
  },
  description:
    "Aloyz, işletmeler için WhatsApp ve Instagram mesajlaşma otomasyonu, randevu takibi ve müşteri iletişimi yönetim panelidir.",
  ...
  openGraph: {
    title: "Aloyz",
    description:
      "WhatsApp ve Instagram otomasyonu ile müşteri iletişimi yönetimi.",
    url: "https://www.aloyz.co",
    siteName: "Aloyz",
